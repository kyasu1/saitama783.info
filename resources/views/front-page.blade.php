...
@section('content')
  ...
  <div>
    ...
    <hr class="my-bg-dark-blue">
    <h3 class="tc my-purple">
      03<br>質料のお支払で期限の延⻑も可能
    </h3>
    <p class="ph1 ph3-ns">質料(利息)をお支払い頂いた場合、質預かりの期限の延⻑をすることもできます。
※質料(利息)については、質屋営業法で定められた範囲内で、店舗ごとに設定しています。詳細は各店舗に問い合わせください。</p>
    <hr class="my-bg-dark-blue">
    <h3 class="tc my-purple">
      04<br>ご返済の義務はありません
    </h3>
    ...
    <p class="ph1 ph3-ns">お客様がお持ちになったお品物を、査定し、買取させていただきます。「もう使わないけど、捨てるにはもったいない」「飽きてしまったので新しい物に買い換えたい」という時は、「買取」というシステムをご利用下さい。</p>
    <p class="ph1 ph3-ns"> 「買取」は、「質預かり」とは違い、一度売ってしまうと、お品物はもうお客様の手元には戻りません。買取が成立した時点でお品物の所有権は質屋に移ります。</p>
    <p class="ph1 ph3-ns"> 「大切な品物を手放したくない」または、「手放すかどうか迷っている」という方は、「質預かり」というシステムのご利用をおすすめいたします。</p>
    <hr class="my-bg-dark-blue">
    <h3 class="tc my-purple">
      07<br>より高く売るためには?
    </h3>
